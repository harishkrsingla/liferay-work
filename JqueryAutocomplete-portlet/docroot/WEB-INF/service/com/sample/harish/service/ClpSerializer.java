...
import com.sample.harish.model.StudentClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"JqueryAutocomplete-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "JqueryAutocomplete-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals("com.sample.harish.model.impl.StudentImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.sample.harish.NoSuchStudentException")) {
			return new com.sample.harish.NoSuchStudentException();
		}

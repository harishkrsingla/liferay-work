...
import com.sample.harish.NoSuchStudentException;
import com.sample.harish.model.Student;
import com.sample.harish.model.impl.StudentImpl;
import com.sample.harish.model.impl.StudentModelImpl;
...
public class StudentPersistenceImpl extends BasePersistenceImpl<Student>
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_COURSELIKE =
		new FinderPath(StudentModelImpl.ENTITY_CACHE_ENABLED,
			StudentModelImpl.FINDER_CACHE_ENABLED, StudentImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByCourseLike",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_COURSELIKE =
		new FinderPath(StudentModelImpl.ENTITY_CACHE_ENABLED,
			StudentModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByCourseLike",
	...
	@Override
	public Student updateImpl(com.sample.harish.model.Student student,
	...
	public List<Student> findByCourseLike(String course)
		throws SystemException {
		return findByCourseLike(course, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Student> findByCourseLike(String course, int start, int end)
		throws SystemException {
		return findByCourseLike(course, start, end, null);
	}
	...
	public List<Student> findByCourseLike(String course, int start, int end,
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_COURSELIKE;
		finderArgs = new Object[] { course, start, end, orderByComparator };
		...
		if ((list != null) && !list.isEmpty()) {
			for (Student student : list) {
				if (!Validator.equals(course, student.getCourse())) {
					list = null;
		...
		if (list == null) {
			...
			if (course == null) {
				query.append(_FINDER_COLUMN_COURSELIKE_COURSE_1);
			}
			else {
				if (course.equals(StringPool.BLANK)) {
					query.append(_FINDER_COLUMN_COURSELIKE_COURSE_3);
				}
				else {
					query.append(_FINDER_COLUMN_COURSELIKE_COURSE_2);
				}
			}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Student findByCourseLike_First(String course,
		OrderByComparator orderByComparator)
		throws NoSuchStudentException, SystemException {
		Student student = fetchByCourseLike_First(course, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Student fetchByCourseLike_First(String course,
		OrderByComparator orderByComparator) throws SystemException {
		List<Student> list = findByCourseLike(course, 0, 1, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Student findByCourseLike_Last(String course,
		OrderByComparator orderByComparator)
		throws NoSuchStudentException, SystemException {
		Student student = fetchByCourseLike_Last(course, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Student fetchByCourseLike_Last(String course,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByCourseLike(course);

		List<Student> list = findByCourseLike(course, count - 1, count,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Student[] findByCourseLike_PrevAndNext(long studentId,
		String course, OrderByComparator orderByComparator)
		throws NoSuchStudentException, SystemException {
		...
		try {
			...
			array[0] = getByCourseLike_PrevAndNext(session, student, course,
					orderByComparator, true);

			array[1] = student;

			array[2] = getByCourseLike_PrevAndNext(session, student, course,
	...
	protected Student getByCourseLike_PrevAndNext(Session session,
		Student student, String course, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCourseLike(String course) throws SystemException {
		for (Student student : findByCourseLike(course)) {
			remove(student);
		}
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int countByCourseLike(String course) throws SystemException {
		Object[] finderArgs = new Object[] { course };

		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_COURSELIKE,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_COURSELIKE,
					finderArgs, count);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.sample.harish.model.Student")));
	...
	private static final String _FINDER_COLUMN_COURSELIKE_COURSE_1 = "student.course LIKE NULL";
	private static final String _FINDER_COLUMN_COURSELIKE_COURSE_2 = "student.course LIKE ?";
	private static final String _FINDER_COLUMN_COURSELIKE_COURSE_3 = "(student.course IS NULL OR student.course LIKE ?)";
